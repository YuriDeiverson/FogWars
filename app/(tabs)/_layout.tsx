...
const ti = StyleSheet.create({
  wrap: { width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  wrapOn: {
    backgroundColor: '#00ff96',
    shadowColor: '#00ff96', shadowOpacity: 0.5, shadowRadius: 10, elevation: 6,
  },
  badge: {
    position: 'absolute', top: -2, right: -2,
    backgroundColor: '#ff4466', borderRadius: 8,
    minWidth: 16, height: 16, alignItems: 'center', justifyContent: 'center',
    borderWidth: 1.5, borderColor: '#080a12', paddingHorizontal: 3,
  },
      ...
      >
        ...
        <Tabs.Screen
          ...
          options={{
            title: 'Conquistas',
            tabBarIcon: ({ focused }) => (
              <TabIcon name="trophy" focused={focused} badge={pendingAchievements.length} />
            ),
          }}
        />
        <Tabs.Screen
